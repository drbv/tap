        ...
        >
            ...
            <Grid container spacing={4}>
                  ...
                  <Select
                    ...
                    onChange={(e) => {
                      this.setState((prevState) => {
                        ...
                        localRound.roundType = e.target.value; // update the name property, assign a new value
                        return { localRound }; // return new object
                      });
                    }}
                  >
                    <MenuItem value="qualifying">
                      {translate("round.roundTypes.qualifying")}
                    </MenuItem>
                    <MenuItem value="intermediate">
                      {translate("round.roundTypes.intermediate")}
                    </MenuItem>
                    <MenuItem value="hope">
                      {translate("round.roundTypes.hope")}
                    </MenuItem>
                    <MenuItem value="finals">
                      {translate("round.roundTypes.finals")}
                    </MenuItem>
                  </Select>
                </div>
                <div className={classes.inputContent}>
                  ...
                  <Select
                    ...
                    onChange={(e) => {
                      ...
                      this.setState((prevState) => {
                        ...
                        localRound.league = e.target.value; // update the name property, assign a new value
                        return { localRound }; // return new object
                      });
                    }}
                  >
                  ...
                  <Select
                    ...
                    onChange={(e) => {
                      this.setState((prevState) => {
                        ...
                        localRound.evaluationTemplateId = e.target.value; // update the name property, assign a new value
                        return { localRound }; // return new object
                      });
                    }}
                  >
                  ...
                  <Select
                    ...
                    onChange={(e) => {
                      this.setState((prevState) => {
                        ...
                        localRound.acroTemplateId = e.target.value; // update the name property, assign a new value
                        return { localRound }; // return new object
                      });
                    }}
                  >
              ...
              <Grid item xs={4}>
                ...
                <div className={classes.inputContent}>
                  ...
                  {localRound.judgeIds &&
                    localRound.judgeIds.map((singleJudgeId, index) => {
                      return (
                        <Select
                          fullWidth
                          inputProps={{
                          ...
                          onChange={(e) => {
                            this.setState((prevState) => {
                              ...
                              localRound.judgeIds[index] = e.target.value; // update the name property, assign a new value
                              return {
                                localRound,
                              }; // return new object
                            });
                          ...
                          {this.state.users &&
                            this.state.users.map((user) => {
                              return (!localRound.observerIds ||
                                !localRound.observerIds.includes(user)) &&
                                (!localRound.acroJudgeIds ||
                                  !localRound.acroJudgeIds.includes(user)) &&
                                (!localRound.judgeIds ||
                                  !localRound.judgeIds.includes(user)) ? (
                ...
                <div className={classes.inputContent}>
                  ...
                  {localRound.acroJudgeIds &&
                    localRound.acroJudgeIds.map((singleJudgeId, index) => {
                      return (
                        <Select
                          fullWidth
                          inputProps={{
                          ...
                          onChange={(e) => {
                            this.setState((prevState) => {
                              ...
                              localRound.acroJudgeIds[index] = e.target.value; // update the name property, assign a new value
                              return {
                                localRound,
                              }; // return new object
                            });
                ...
                <div className={classes.inputContent}>
                  ...
                  {localRound.observerIds &&
                    localRound.observerIds.map((singleObserverId, index) => {
                      return (
                        <Select
                          fullWidth
                          inputProps={{
                          ...
                          onChange={(e) => {
                            this.setState((prevState) => {
                              ...
                              localRound.observerIds[index] = e.target.value; // update the name property, assign a new value
                              return {
                                localRound,
                              }; // return new object
                            });
              ...
              <Grid item xs={4}>
                ...
                <div className={classes.inputContent}>
                  ...
                  {localRound.subrounds &&
                    localRound.subrounds.map((singleSubround, index) => {
                      return (
                        <div>
                          <Select
                            fullWidth
                            ...
                            value={
                              ...
                              singleSubround.participants[0]
                            }
                            onChange={(e) => {
                              this.setState((prevState) => {
                                let localRound = JSON.parse(
                                  JSON.stringify(this.state.localRound)
                                ); // creating copy of state variable
                                localRound.subrounds[index].participants[0] =
                          ...
                          >
                            {this.state.competition &&
                              this.state.competition.map((competition) => {
                                return (
                                  <MenuItem value={competition.bookId}>
                                    {competition.bookId}
                                  </MenuItem>
                                );
                              })}
                          ...
                          <Select
                            ...
                            onChange={(e) => {
                              this.setState((prevState) => {
                                ...
                                // creating copy of state variable
                                localRound.subrounds[index].status =
                                  e.target.value; // update the name property, assign a new value
                                return {
                                  localRound,
                                }; // return new object
          ...
          <DialogActions>
            ...
            <Button
              ...
              onClick={async () => {
                this.upsertRound(localRound).then(this.props.handleClose());
              }}
              color="primary"
              variant="contained"
            >
