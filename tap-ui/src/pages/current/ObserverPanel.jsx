        ...
        <Grid container justifyContent="center" alignItems="center" spacing={1}>
            ...
            <div>
              ...
              >
                {evaluationTemplate &&
                  ...
                  evaluationTemplate.deduction.map((deduction) => {
                    return (
                      <Button
                        variant="contained"
                        color="error"
          ...
          <Grid item xs={12}>
            <div>
              ...
              >
                {currentResult &&
                  currentResult.deduction &&
                  currentResult.deduction.map((deduction, index) => {
                    return (
                      <Button
                        variant="contained"
                        color="error"
                        ...
                        onClick={() => {
                          ...
                          localResult.deduction &&
                            localResult.deduction.splice(index, 1);
          ...
          <Grid item xs={12}>
            ...
            >
              <Button
                ...
                onClick={() => {
                  const localResult = JSON.parse(JSON.stringify(currentResult));
