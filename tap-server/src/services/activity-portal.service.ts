...
import {StartDataBwData} from '../../../shared/models/competition/start-data-bw-data.model'
import {StartDataRrData} from '../../../shared/models/competition/start-data-rr-data.model'
...
import {StartDataWrTlData} from '../../../shared/models/competition/start-data-wr-tl-data.model'
...
import {FormationData} from '../../../shared/models/competition/formation-data.model'
import {DrbvAcroData} from '../../../shared/models/competition/drbv-acro-data.model'
import {StartDataAppointmentData} from '../../../shared/models/competition/start-data-appointment-data.model'
import {CompetitionData} from '../../../shared/models/competition/competition-data.model'
            ...
            try {
                if (row.RFID1 != null && row.RFID2 != null ){
                    await this.db.athletes.upsert({
                        ...
                        book_id: row.Buchnr ? row.Buchnr : 0,
